		...
		function gotVRDevices( devices ) {
			...
			for ( var i = 0; i < devices.length; ++ i ) {
				if ( devices[i] instanceof HMDVRDevice ) {
					...
					self.leftEyeTranslation = vrHMD.getEyeTranslation( "right" );
					self.rightEyeTranslation = vrHMD.getEyeTranslation( "left" );
					self.leftEyeFOV = vrHMD.getRecommendedEyeFieldOfView( "right" );
					self.rightEyeFOV = vrHMD.getRecommendedEyeFieldOfView( "left" );
